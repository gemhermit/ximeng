...
const slides = [
  {
    ...
    desc: { zh: '产线自动化与预测维护，提升生产效率 35%，降低设备故障率 40%。', en: 'Production automation and predictive maintenance that improve efficiency by 35% and reduce equipment failure rate by 40%.' },
    img: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070&auto=format&fit=crop',
    color: 'blue',
  },
  {
    id: 2,
    title: { zh: '教育科技', en: 'Education Technology' },
    sub: 'EDUCATION TECHNOLOGY',
    desc: { zh: '知识图谱与沉浸式教学，提升学生学习兴趣 60%，记忆留存率提高 50%。', en: 'Knowledge graphs and immersive teaching experiences that lift engagement by 60% and retention rate by 50%.' },
    img: 'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?q=80&w=2078&auto=format&fit=crop',
    color: 'green',
  },
  {
    id: 3,
    title: { zh: '文化旅游', en: 'Cultural Tourism' },
    sub: 'CULTURAL TOURISM',
    desc: { zh: '元宇宙景区复刻，打造沉浸式旅游体验，游客满意度提升 70%。', en: 'Digital venue replicas and immersive tourism experiences that raise visitor satisfaction by 70%.' },
    img: 'https://images.unsplash.com/photo-1508138221679-760a23a2285b?q=80&w=2070&auto=format&fit=crop',
    color: 'pink',
  },
  {
    id: 4,
    title: { zh: '云引擎服务', en: 'Cloud Engine Services' },
    sub: 'CLOUD ENGINE SERVICES',
    desc: { zh: '弹性算力底座，支持海量并发请求，服务可用性达到 99.99%。', en: 'Elastic computing foundations that support massive concurrent requests with 99.99% service availability.' },
    img: '/images/solution-cloud.jpg',
    color: 'cyan',
  },
  {
    id: 5,
    title: { zh: '全域 AI 营销', en: 'Omnichannel AI Marketing' },
    sub: 'OMNICHANNEL AI MARKETING',
    desc: { zh: '数据驱动精准获客，营销转化率提升 80%，获客成本降低 40%。', en: 'Data-driven acquisition workflows that increase conversion rate by 80% while reducing acquisition cost by 40%.' },
    img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=2080&auto=format&fit=crop',
    color: 'purple',
  },
  {
    id: 6,
    title: { zh: 'AI 硬件定制', en: 'Custom AI Hardware' },
    sub: 'AI HARDWARE CUSTOMIZATION',
    desc: { zh: '端侧算力芯片开发，为客户提供高性能、低功耗的 AI 硬件解决方案。', en: 'Edge-computing chip and device engineering for high-performance, low-power AI hardware solutions.' },
    img: 'https://images.unsplash.com/photo-1591488320449-011701bb6704?q=80&w=2070&auto=format&fit=crop',
    color: 'orange',
  },
];
